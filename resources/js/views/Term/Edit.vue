<template>
    <div class="term-edit">
        ...
        <el-form ref="term" :model="term" label-width="120px">
            ...
            <el-form-item>
                <el-button type="primary" @click="termUpdate">Update</el-button>
...
<script>
    export default {
        mounted() {
            this.getTerm(this.$route.params.id);
        },
        ...
        methods: {
            ...
            termUpdate() {
                this.$refs['term'].validate((valid) => {
                    ...
                    api.call('post', 'terms/' + this.$route.params.id, data)
                        .then(({data}) => {
